...
public class Constant {
    ...
    public static final String HBASE_NAMESPACE = "flink_realtime";

    public static final String MYSQL_DRIVER = "com.mysql.cj.jdbc.Driver";
    public static final String MYSQL_URL = "jdbc:mysql://cdh03:3306/flink_realtime?useSSL=false";
    ...
    public static final String DORIS_FE_NODES = "cdh01:8031";

    public static final String DORIS_DATABASE = "flink_realtime";
}
